...
$router->add("GET", "/results", "results.php", "showresults", array("baselines" => "array", "times" => "array", "players" => "array", "errorbars" => "bool", "simpledata" => "bool", "latexdata" => "bool", "data" => "bool", "scale" => "bool"));
